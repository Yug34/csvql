            ...
            <Card className={"w-full border-none p-0"}>
                {csvData ? (
                    <>
                        ...
                        <CardContent>
                            <Input type={"text"} placeholder={"Enter new table name"} name="table_name" onChange={(e) => {
                                console.log(e.target.value);
                            }}/>
                            <div className={"whitespace-pre"}>{csvData}</div>
                            <Button className={"w-full mt-6"} onClick={() => {}}>Create table</Button>
                        </CardContent>
                    </>
                    ) : (
                    <>
